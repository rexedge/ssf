...
const Values: React.FC = () => {
	return (
		<section className='min-h-full bg-primary dark:bg-primary-foreground'>
			<div className='max-w-6xl mx-auto px-4 py-10 text-center text-background'>
				<h2 className='text-4xl font-bold mb-16'>Our Values</h2>
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
					<div className='flex flex-col items-center'>
						<UserGroupIcon className='h-16 w-16 text-tertiary' />
					...
					<div className='flex flex-col items-center'>
						<CurrencyDollarIcon className='h-16 w-16 text-tertiary' />
						<h3 className='text-xl font-bold mb-2'>
					...
					<div className='flex flex-col items-center'>
						<LightBulbIcon className='h-16 w-16 text-tertiary' />
						<h3 className='text-xl font-bold mb-2'>
